...
static void check_recv()
{
	...
	for (;i < PNUM;i++) {
		/*
		if ( reg_read_32( (receive_desc[i].desc2 | 0xa0000000) ) == 0xb57b5500) {
		//if (receive_desc[i].desc0 != 0x4e0320 && (receive_desc[i].desc0 & 0x80000000) == 0) {
		...
		*/
		if ((receive_desc[i].desc0 & 0x80000000) == 0x80000000) {
			recv_64 = 0;
			break;
		}
	}
